...
//        } else ActionResult.SUCCESS
    ...
    companion object {
        ...
        private val HEAD_NORTH: VoxelShape =
            VoxelShapes.union(createCuboidShape(2.0, 2.0, 0.0, 14.0, 14.0, 2.0), HOLDER_NORTH)
        private val HEAD_EAST: VoxelShape =
            VoxelShapes.union(createCuboidShape(14.0, 2.0, 2.0, 16.0, 14.0, 14.0), HOLDER_EAST)
        private val HEAD_SOUTH: VoxelShape =
            VoxelShapes.union(createCuboidShape(2.0, 2.0, 14.0, 14.0, 14.0, 16.0), HOLDER_SOUTH)
        private val HEAD_WEST: VoxelShape =
            VoxelShapes.union(createCuboidShape(0.0, 2.0, 2.0, 2.0, 14.0, 14.0), HOLDER_WEST)
        private val HEAD_DOWN: VoxelShape =
            VoxelShapes.union(createCuboidShape(2.0, 0.0, 2.0, 14.0, 2.0, 14.0), HOLDER_DOWN)
        private val HEAD_UP: VoxelShape =
            VoxelShapes.union(createCuboidShape(2.0, 14.0, 2.0, 14.0, 16.0, 14.0), HOLDER_UP)
    }
}