...
@JvmName("isRemoteJava")
fun World.isRemote(): Boolean = this.isClient

@Deprecated("fabric", replaceWith = ReplaceWith("this.isClient"))
val World.isRemote: Boolean
    get() = this.isClient
...
@Deprecated(
    "generated",
    replaceWith = ReplaceWith("MyItemGroups.CURED_STORAGE", "com.thinkslynk.fabric.generated.MyItemGroups")
...
@Deprecated(
    "replace with ItemRegistryGenerated",
    replaceWith = ReplaceWith("ItemRegistryGenerated", "com.thinkslynk.fabric.generated.ItemRegistryGenerated")
)
