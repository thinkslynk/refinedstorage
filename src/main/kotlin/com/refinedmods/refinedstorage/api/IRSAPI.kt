...
interface IRSAPI {
     ...
     * @return the comparer
     */
    val comparer: IComparer

    /**
     * @return the quantity formatter
     */
    val quantityFormatter: IQuantityFormatter

    /**
     * @return the network node factory
     */
    val networkNodeRegistry: INetworkNodeRegistry
...
//    fun createCraftingRequestInfo(tag: CompoundTag): ICraftingRequestInfo
     ...
     */
    val patternRenderHandlers: List<ICraftingPatternRenderHandler>
