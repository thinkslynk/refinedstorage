...
class GridContainer(val grid: IGrid?, gridTile: BaseTile?, player: PlayerEntity, windowId: Int):
        BaseContainer(RSContainers.GRID, gridTile, player, windowId), ICraftingGridListener {
