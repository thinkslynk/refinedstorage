...
//
//class ItemGridView(screen: GridScreen, defaultSorter: IGridSorter, sorters: List<IGridSorter>) : BaseGridView(screen, defaultSorter, sorters) {
...
//        }
//        val existing = map[stack.getId()] as ItemGridStack?
//        if (existing == null) {
//            stack.stack.count = delta
//            map[stack.getId()] = stack
//        } else {
//            if (existing.stack.count + delta <= 0) {
