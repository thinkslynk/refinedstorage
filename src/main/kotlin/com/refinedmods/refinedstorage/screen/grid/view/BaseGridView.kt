...
//    var myStacks = mutableListOf<IGridStack>()
...
//            stacks.sortWith(java.util.Comparator { left: IGridStack, right: IGridStack -> defaultSorter.compare(left, right, sortingDirection) })
//            for (sorter in sorters) {
//                if (sorter.isApplicable(grid)) {
//                    stacks.sortWith(java.util.Comparator { left: IGridStack, right: IGridStack -> sorter.compare(left, right, sortingDirection) })
//                }
//            }
//        }
//        myStacks = stacks
