...
class FluidStorageDiskItem(private val type: FluidStorageType) : Item(
    ...
    override fun inventoryTick(
        ...
        if (!world.isClient && !stack.hasTag()) {
            ...
            world as ServerWorld // TODO create an extension function `world.isServer()` that cast the world
    ...
    override fun use(world: World, player: PlayerEntity, hand: Hand): TypedActionResult<ItemStack> {
        ...
        if (!world.isClient && player.isSneaking && type != FluidStorageType.CREATIVE) {
            world as ServerWorld
            val disk = API.getStorageDiskManager(world).getByStack(diskStack)
            if (disk != null && disk.getStored() == 0) {
                val storagePart = ItemStack(FluidStoragePartItem.getByType(type), diskStack.count)
    ...
    companion object {
        ...
        private val LOGGER = LogManager.getLogger(FluidStorageDiskItem::class.java)
    }
}
